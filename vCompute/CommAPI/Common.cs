...
namespace CommAPI
{
	public enum CommandType { REQUEST = 101,APPEND_REQUEST, DOWNLOAD, EXECUTE,EXECUTE_APPEND, DELETE, PING, REGISTER_CLIENT, REGISTER_ASSEMBLY, UPLOAD_ASSEMBLY,RESULT, APPEND_ASSEMBLY,APPEND_RESULT, STATUS, DISCOVERY, CLIENT_REGISTRTION }
	public class Common
	{
